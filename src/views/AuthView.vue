  ...
  <div class="min-h-screen flex items-center justify-center bg-gradient-to-br from-blue-50 to-indigo-100">
    <div class="bg-white p-8 rounded-lg shadow-xl w-full max-w-md">
      <div class="text-center mb-6">
        ...
        <p class="text-gray-600">Gérez vos projets et tâches efficacement</p>
      </div>

      <div class="flex gap-2 mb-6">
        <button
          @click="isLogin = true"
          :class="isLogin ? 'bg-blue-600 text-white' : 'bg-gray-200 text-gray-700'"
      ...
      <button
        @click="googleLogin"
        :disabled="loading"
        class="w-full bg-white border-2 border-gray-300 text-gray-700 py-2 rounded-lg font-medium hover:bg-gray-50 disabled:opacity-50 disabled:cursor-not-allowed transition flex items-center justify-center gap-2"
      >
